...
#
# Original file obtained from: https://github.com/circulosmeos/gdown.pl (9/26/20)
#
use strict;
use POSIX;
...
# Model URL
my $URL='https://drive.google.com/file/d/149j5rlynkO1jQTLOMpL5lextHY0ozw6N';

# file output
my $FILENAME='300_net_G.pth';
